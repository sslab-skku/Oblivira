...
public class ResolveServlet extends WebUniResolver {
	...
	try {
	    ...
	    //WebUniResolver.sendResponse(response, HttpServletResponse.SC_INTERNAL_SERVER_ERROR, null, "[UNIRESOLVER] Successfully transferred to corresponding driver: " + identifier);
	    return;
	}
